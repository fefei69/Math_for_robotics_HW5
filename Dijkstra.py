...
def main():
    ...
    #     ox.append(i)
    #     oy.append(0.0)
    #     xl,yl = check_cspace_2x2(i, 0.0)
    #     cspace_x += xl
    #     cspace_y += yl
    # for i in range(0, 300):
    #     ox.append(800.0)
    #     oy.append(i)
    #     xl,yl = check_cspace_2x2(800.0, i)
    #     cspace_x += xl
    #     cspace_y += yl
    # for i in range(0, 801):
    #     ox.append(i)
    #     oy.append(300.0)
    #     xl,yl = check_cspace_2x2(i, 300.0)
    #     cspace_x += xl
    #     cspace_y += yl
    # for i in range(0, 301):
    #     ox.append(0.0)
    #     oy.append(i)
    #     xl,yl = check_cspace_2x2(0.0, i)
    #     cspace_x += xl
    #     cspace_y += yl
    # #obstacles
    # #left obstacle
    ...
    #     ox.append(199.0)
    #     oy.append(i)
    #     xl,yl = check_cspace_2x2(199.0, i)
    #     cspace_x += xl
    #     cspace_y += yl
    # for i in range(0, 200):
    #     ox.append(100.0 + i)
    #     oy.append(199.0)
    #     xl,yl = check_cspace_2x2(100.0 + i, 199.0)
    #     cspace_x += xl
    #     cspace_y += yl
    #     #mid obstacles
    # for i in range(0, 200):
    #     ox.append(400.0)
    #     oy.append(100.0 + i)
    #     xl,yl = check_cspace_2x2(400.0, 100.0 + i)
    #     cspace_x += xl
    #     cspace_y += yl
    # #right obstacle
    # for i in range(0, 200):
    #     ox.append(599.0)
    #     oy.append(i)
    #     xl,yl = check_cspace_2x2(599.0, i)
    #     cspace_x += xl
    #     cspace_y += yl
    # for i in range(0, 200):
    #     ox.append(500.0 + i)
    #     oy.append(199.0)
    #     xl,yl = check_cspace_2x2(500.0 + i, 199.0)
    #     cspace_x += xl
    #     cspace_y += yl
    if show_animation:  # pragma: no cover
